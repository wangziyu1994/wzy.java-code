...
import com.wangziyu.rpcstudy.proxy.NettyHttpInvocationHandler;
...
public class NettyHttpConsumer {
    ...
    public static <T>T getProxyObject(Class<T> target){
        NettyHttpInvocationHandler invocationHandler=new NettyHttpInvocationHandler(target,new InetSocketAddress(localhost,port));
        ClassLoader classLoader= NettyHttpConsumer.class.getClassLoader();
